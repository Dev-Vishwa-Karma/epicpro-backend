    ...
    case 'add':
        ...
        <body>
            <div class="container">
                ...
                <p><span class="info-label">Name:</span> ' . $fullname . '</p>
                <p><span class="info-label">Email:</span> ' . $email . '</p>
                <p><span class="info-label">Phone:</span> ' . $phone . '</p>
                <p><span class="info-label">Address:</span> ' . $streetaddress . '</p>
                <p><span class="info-label">Experience:</span> ' . $experience . '</p>
            ...
            $messageApplicant = '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border:1px solid #e0e0e0; border-radius:8px; overflow:hidden;">
