...
class EmailTemplate
{
        ...
        <body>
          ...
          <div class='container'>
            ...
            <div class='content'>
              ...
              <p>
                Your Profilics Systems account password has been
                successfully changed.
              </p>

              <div class='success-box'>
                <strong>Password Updated</strong><br>
                Your new password is now active and can be used to
   ...
   *
   * @param array $userName The user data.
   ...
   *
   * @param string $userName The user data.
   * @param string $newEmail The new email data.
   * @param string $otpCode The OTP data.
   * @return string The HTML template.
   */
   ...
   *
   * @param string $userName The user data.
   * @param string $subject The subject data.
   * @return string The HTML template.
   */
